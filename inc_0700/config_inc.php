...
define('VIRTUAL_PATH', 'http://kyrrahnork.com/sm17/'); # Virtual (web) 'root' of application for images, JS & CSS files
define('PHYSICAL_PATH', '/home/kyrnor/kyrrahnork.com/sm17/'); # Physical (PHP) 'root' of application for file & upload reference
...
define('PREFIX', 'sm17_'); #Prefix to add uniqueness to your DB table names.  Limits hackability, naming collisions
